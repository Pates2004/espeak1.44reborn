...
AppVersion=1.44.05
AppVerName=eSpeak version 1.44.05 r25 (32-bit)
...
OutputBaseFilename=setup_espeak-1.44.05-x86-r25
Compression=lzma2/ultra64
SolidCompression=yes
ShowLanguageDialog=auto
UninstallDisplayIcon={app}\TTSApp.exe
VersionInfoVersion=1.44.5.25
VersionInfoProductName=eSpeak
VersionInfoDescription=eSpeak 1.44.05 r25 native 32-bit installer
