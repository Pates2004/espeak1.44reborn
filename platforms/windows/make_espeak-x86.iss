...
AppVersion=1.44.05
AppVerName=eSpeak version 1.44.05 r28 (32-bit)
...
OutputBaseFilename=setup_espeak-1.44.05-x86-r28
Compression=lzma2/ultra64
SolidCompression=yes
ShowLanguageDialog=auto
UninstallDisplayIcon={app}\TTSApp.exe
VersionInfoVersion=1.44.5.28
VersionInfoProductName=eSpeak
VersionInfoDescription=eSpeak 1.44.05 r28 native 32-bit installer
