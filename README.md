# eSpeak 1.44.05 Reborn — r23 (32-bit)
...
applications and SAPI clients.  The `r23` label follows the 64-bit baseline;
...
creates `build\x86\installer\setup_espeak-1.44.05-x86-r23.exe`.
